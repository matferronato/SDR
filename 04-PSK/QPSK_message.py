...
class QPSK_message(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK_message")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK_message")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QPSK_message")
        ...
        self.tabs_layout_1.addWidget(self._LO_Range_win)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.center_freq-self.LO_Range, self.samp_rate)
...
def main(top_block_cls=QPSK_message, options=None):
