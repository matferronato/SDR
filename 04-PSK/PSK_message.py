...
class PSK_message(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PSK_message")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PSK_message")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PSK_message")
...
def main(top_block_cls=PSK_message, options=None):
