...
class ask(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radians = radians = 3.14
        self.cw_frq = cw_frq = 1e3
        ...
        self.tabs.addTab(self.tabs_widget_0, '1_time_input')
        self.tabs_widget_1 = Qt.QWidget()
        self.tabs_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tabs_widget_1)
        self.tabs_grid_layout_1 = Qt.QGridLayout()
        self.tabs_layout_1.addLayout(self.tabs_grid_layout_1)
        self.tabs.addTab(self.tabs_widget_1, '2_freq')
        ...
        self.tabs.addTab(self.tabs_widget_5, 'Tab 5')
        self.top_grid_layout.addWidget(self.tabs)
        self._radians_range = Range(3, 3.14159265359, 0.00001, 3.14, 200)
        self._radians_win = RangeWidget(self._radians_range, self.set_radians, 'radians', "counter_slider", float)
        self.top_grid_layout.addWidget(self._radians_win)
        self._cw_frq_range = Range(1e3, 16e3, 100, 1e3, 200)
        self._cw_frq_win = RangeWidget(self._cw_frq_range, self.set_cw_frq, 'cw_frq', "counter_slider", float)
        self.top_grid_layout.addWidget(self._cw_frq_win)
        # Create the options list
        self._variable_qtgui_chooser_0_options = (0, 1, )
        # Create the labels list
        self._variable_qtgui_chooser_0_labels = ('Square_wave', 'Zero', )
        ...
        self.tabs_layout_3.addWidget(self._qtgui_time_sink_x_0_0_0_win)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, cw_frq/1000, 1, 0, radians)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, cw_frq/1000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, cw_frq*2, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_float_to_complex_0_0, 0))
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_float_to_complex_0_0, 1))
        self.connect((self.analog_sig_source_x_1_0, 0), (self.qtgui_time_sink_x_0_0_0, 1))
        ...
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.qtgui_time_sink_x_0_0, 2))
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_time_sink_x_0_0, 3))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.cw_frq/100, self.cw_frq/50, firdes.WIN_HAMMING, 6.76))
    ...
    def set_radians(self, radians):
        ...
        self.analog_sig_source_x_1_0.set_phase(self.radians)
    ...
    def set_cw_frq(self, cw_frq):
        ...
        self.analog_sig_source_x_0_0.set_frequency(self.cw_frq*2)
        self.analog_sig_source_x_1.set_frequency(self.cw_frq/1000)
        self.analog_sig_source_x_1_0.set_frequency(self.cw_frq/1000)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.cw_frq/100, self.cw_frq/50, firdes.WIN_HAMMING, 6.76))
